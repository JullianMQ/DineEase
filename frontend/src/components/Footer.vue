...
const menus = ref([
  {
    title: 'Explore',
    items: [
      { text: 'View Our Menu', link: '/menu' },
      { text: 'Reserve a Table', link: '/reservation' },
  ...
  },
  {
    title: 'Company',
    items: [
      { text: 'About DineEase', link: '/about' },
...
<template>
  <footer class="mx-2 relative z-10 bg-white pt-20 lg:pt-[120px]">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <RouterLink to="" class="mb-6 inline-block max-w-[160px]">
              <img
                src="/DineEase-NOBG.png"
                alt="logo"
                class="max-w-full"
            </RouterLink>
            <p class="text-base text-body-color mb-7">
              DineEase helps restaurants connect with customers through easy online reservations and
              digital menus.
            </p>
        ...
        <div v-for="menu in menus" :key="menu.title" class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
            <h4 class="text-lg font-semibold text-dark mb-9">{{ menu.title }}</h4>
            <ul class="space-y-3">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            ...
            <p class="text-base text-body-color">&copy; 2025 DineEase</p>
          </div>
        </div>
      </div>
    </div>
